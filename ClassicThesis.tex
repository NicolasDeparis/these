...
%\include{Chapters/part_00/preface}
%\include{Chapters/part_00/intro}
...
\part{Contexte}
\include{Chapters/part_01/CDM}
\include{Chapters/part_01/reionization}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\include{Chapters/part_02/EMMA}
\include{Chapters/part_02/solveurs}
\include{Chapters/part_02/materiel}
...
\part{Étude de l'influence de la composante stellaire dans les simulations de l'époque de réionisation}
\include{Chapters/part_03/etoiles}
\include{Chapters/part_03/supernovae}
\include{Chapters/part_03/halos}
...
%
\cleardoublepage
\ctparttext{Cette partie est liée à la publication présentée en annexe\,\ref{pap:c}.\medskip
...
Ainsi qu'à la publication présentée en annexe\,\ref{pap:z0}.\medskip

\emph{"Relating the reionization time of galaxies to their present halo masses"}\medskip

Dominique Aubert, Nicolas Deparis, Pierre Ocvirk et al.
En  préparation.
}
\part{Étude de la propagation de l'ionisation dans les simulations à l'aide des cartes de redshifts de réionisation}
\include{Chapters/part_04/carte_reio}
\include{Chapters/part_05/z0}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\include{Chapters/part_06/visualisation}
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{Chapters/part_07/conclusion}
...
\cleardoublepage\include{FrontBackmatter/papers/publications}
%%%********************************************************************
