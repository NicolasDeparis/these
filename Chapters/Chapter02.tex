...
Ce type de calculateur est composé d'un certain nombre de nœud relié qui communique entre eux par l'intermédiaire d'un réseau.
...
Les coeurs au sein d'un même CPU pourront communiquer entre eux de faible quantité de données par l'intérmédiaire du cache, ou en passant par la RAM pour les volumes plus importants.


Tout les processus au sein d'un même noeud pourront communiquer par l'intermédiaire de la RAM si
