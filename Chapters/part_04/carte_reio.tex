\chapter[Influence de la RSLA sur la propagation de l'ionisation]{Influence du l'approximation de vitesse de la lumière réduite sur la propagation de l'ionisation}
...
Partant du principe que les cartes de redshifts de réionisation contiennent l'information d'une grande partie de l'évolution de la fraction d'ionisation dans la simulation, il est possible d'en extraire la vitesse de propagation des fronts d'ionisation.
...
%ne se font pas ioniser par la même source.
...
%Meilleure sera la résolution temporelle de la carte de redshifts, meilleur sera le calcul de la vitesse des fronts.

%Du fait de ces problème, cette méthode nécessite une grande résolution temporelle
...
Dans le cas où la vitesse de la lumière réduite est inférieure à 5\% de la vitesse de la lumière réelle, la limitation de vitesse apparaît dès le début de la réionisation. % et le rayonnement 
