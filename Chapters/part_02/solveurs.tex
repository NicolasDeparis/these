...
Étant donné que le processus chimique sont uniquement local (ie ils ne dépendent pas de l'état des cellules voisines) et que la quantité de calcul est relativement importante, le portage du solveur chimique sur \ac{GPU} est très intéressant du point de vue accélération.

\subsection{Transport sur grille de base}
\label{sec:crta}
%TODO 
Le transport sur grille de base ou \ac{CRTA}
