...
EMMA est une code à grille adaptative \ac{AMR} capable de simuler l'évolution de la matière noire, du gaz et de la radiation de manière auto-cohérente et dans un contexte cosmologique.
...
D'une manière générale, un code \ac{AMR} offre une meilleur conservation de l’énergie mais pourra souffrir de problèmes de diffusion numérique.
