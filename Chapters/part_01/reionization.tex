...
\begin{figure}
        \includegraphics[width=.9\linewidth]{img/01/epaisseur_optique_thomson.pdf} 
...
\begin{figure}
        \includegraphics[width=.9\linewidth]{img/01/pritchardloeb2012fig.pdf} 
...
%Il faut un certain temps pour mettre en place les conditions propices à l'apparition d'un quasar, il n'est pas encore clair que ce temps ait été suffisant avant z=6, pour en former suffisamment.
