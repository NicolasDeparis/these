...
\paragraph{$\Omega_{M,0}$} est la densité d'énergie associée à la matière. % (matière noire que nous introduiront dans la suite et la matière baryonique)
...
\paragraph{$\Omega_{K,0}$} est la densité de courbure spatiale ou la densité d'énergie associée a la courbure de l'espace.
