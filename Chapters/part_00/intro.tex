...
%
Cette thèse porte sur l'étude de l'époque de la réionisation à l'aide de simulations numériques.
...
Pour étudier des phénomènes aussi fortement couplés que ceux considérés dans le cas de l'étude de la réionisation, il est nécessaire d'avoir recours à des simulations numériques. 
...
EMMA, un code de simulations cosmologiques dédié à l'étude de la réionisation, à été mon principal objet d'étude durant cette thèse.
...
Je présenterai une méthode que j'ai développé pour calculer la vitesse des fronts d'ionisation, en utilisant les cartes de réionisation, outils qui sera également introduit dans cette partie.
Cette méthode sera appliquée à une étude sur l'influence de l'approximation de la vitesse de la lumière réduite sur la propagation des fronts d'ionisation dans les simulations.

Le chapitre \ref{sec:CODAEMMA} sera dédié à l'étude des instants d'ionisation des halos à redshift $z=0$.
Cette étude sera mené à l'aide d'une carte de reshift de réionisation générée par la siulation "CoDa I AMR" que j'introduirai.
...
Nous finirons par un rapide rappel des conclusions tirées tout au long de ce manuscrit.
