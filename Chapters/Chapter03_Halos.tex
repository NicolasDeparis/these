...
Comme nous l'avons vu plus tot, %TODO ref
le champ de matière noire utilise une représentation sous forme de particules.

J'ai principalement utilisé l’algorithme Friend Of Friend (FOF) pour détecter les sur-densités. %TODO ref
FOF lie les particules regroupées en surdensité, en utilisant une taille de lien caractéristique.
...
La première possibilité pour déterminer l'étendue spatiale du halo consiste a utiliser l'approximation du $R_{200}$.
...
Maintenant que nous pouvons associer toutes la physique au sein de chaque halo, nous pouvons regarder quelques caractéristiques.
...
Nous avons vu que le rayonnement interagis les baryons, et nous verrons qu'il existe un liens entre la fraction baryonnique determinée plus haut %TODO ref
...
Cette disrcétisation de sphère sera réalisée grace a Healpix.  %TODO ref
