...
\begin{figure}[bth]
        ...
        \caption{Importance respective des différentes densité d'énergie en fonction de l'age de l'Univers (et donc de sa taille). Image extraite de \citep{2005univ.book.....F}
        }
...
On étudie les anisotropies du \ac{CMB} en décomposant ses fluctuations relatives de température en harmoniques sphériques.
...
La première étape pour simuler l'univers, est de déterminer ce qu'il contient, et quelles sont les physiques dominante à considérer, en fonction de ce que l'on cherche a étudier.
...
Une représentation de ces différentes contraintes sur le ration densité d'énergie noire / densité de matière est visible sur la figure \ref{fig:cosmoparam},
Les abondances des différents constituants ne sont pas les seuls parametres libres du modèle standard et une compilation de ces paramètres sont présentés sur la figure \ref{fig:planck_parameters}.
...
\subsection{Énergie noire}
Nous avons deja abordé le sujet de l'énergie noire dans la section \ref{sec:dark_egy}
