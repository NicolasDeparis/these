...
Nous avons associé un redshift de réionisation pour chaque halo à redshift $z=0$ de la simulation Gadget.
...
% nécessitent donc plus de photons pour être réionisés.
