...
Plus le gaz sera chaud, plus le nuage va résister à son effondrement.
...
De plus il en possible de définir une densité en unités physiques ou en unités commobiles (voir section \ref{sec:supercomobil}).
...
Maintenant que nous avons définis où former des étoiles, il nous faut en calculer la quantité.
