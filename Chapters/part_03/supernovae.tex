...
\begin{figure}
        ...
        \caption{Avec le modèle cinétique l'explosion a lieu au sein d'un OCT, et radialement au centre de celui ci.
 		\label{fig:kin}}
\end{figure}
...
\begin{figure}
        ...
        \caption{SFH cosmique en fonction de la méthode d'injection d'énergie.
