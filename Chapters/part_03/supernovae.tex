...
Dans la littérature %dédiée aux simulations comparables %TODO ref
...
Même si celui ci n'a pas d'impact sur le \ac{SFR} global, le taux d'ionisation moyen est fortement dépendant de ce paramètre (cf Fig .\ref{fig:mstar}).
...
Il a une faible influence sur la formation stellaire globale et ne définira la limite de résolution pour les petits halos.
...
Il faudra trouver un compromis entre :
...
\item  et particule stellaire de faible masse, générant une formation stellaire correcte dans les petits halos mais menant à une réionisation plus difficile et une occupation mémoire plus importante.
\end{itemize}

Dans la suite de cette étude, les étoiles seront relativement massive puisque $m_star \approx 7.7 \cdot 10^4 M_\odot$.
