...
%   \newpage
	...
	\acro{CoDa}{Cosmic Dawn}
	\acro{CLUES}{Constrained Local UniversE Simulations}
	\acro{RHD}{Radiation HydroDynamics}
	\acro{FFT}{Fast Fourier Transform}
	\acro{HPC}{High Performance Computing}
	\acro{HLL}{Harten, Lax et van Leer}
	\acro{CFL}{Courant, Friedrichs et Lewy}
    \end{acronym}
\endgroup
